...
// In library-details.txt (JavaScript file)
        ...
        if (libSnap.exists() || articleSnap.exists()) {
            ...
            document.getElementById('details').innerHTML = `
                ...
                <div class="github-section">
                    <p>The information on this website does not include full details about this library. If you are looking for more detailed information, such as license, status or even quick start, you may refer to the GitHub page provided below.</p>
